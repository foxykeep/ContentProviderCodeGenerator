...
How to use DatabaseCodeGenerator
--------------------------------

In order to use it, here are the steps to follow :

1. Download the current version of the project on your computer using git (`git clone git@github.com:foxykeep/DatabaseCodeGenerator.git`). 
2. Import the project in your Eclipse workspace. 
